...
using namespace NEXUS_WINDOWING::Inputs;
...
namespace NEXUS_CORE {
	...
	private:
		static void RegisterLuaKeyNames(lua_State* lua);
		static void RegisterMouseBtnNames(lua_State* lua);
		static void RegisterGamepadBtnNames(lua_State* lua);

	public:
		static InputManager& GetInstance();
		static void CreateLuaInputBindings(lua_State* lua);
